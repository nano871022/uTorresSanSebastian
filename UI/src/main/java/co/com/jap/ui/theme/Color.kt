...
val color_theme_light_on_primary_container = Color(0xFF001C3B)
val color_theme_light_primary_container = Color(0xFF004B7D)

val color_theme_light_secondary = Color(0xFF1A237E)
val color_theme_light_on_secondary = Color(0xFFFFFFFF)

val color_theme_light_secondary_container = Color(0xFF004B7D)
val color_theme_light_on_secondary_container = Color(0xFF001C3B)
...
val color_theme_light_on_surface = Color(0xFFCFD8DC)
