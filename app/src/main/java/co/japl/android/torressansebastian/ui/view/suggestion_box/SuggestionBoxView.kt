package co.japl.android.torressansebastian.ui.view.suggestion_box
...
import co.japl.android.torressansebastian.controller.suggestionbox.SuggestionBoxViewModel
...
@Composable
fun SuggestionBox(
    viewModel: SuggestionBoxViewModel = hiltViewModel()
    ...
    if (loaderState) {
        ...
        Title(title = stringResource(id = R.string.suggestion_box_title), icon = Icons.Rounded.UploadFile) {
